 ...
 * @author erick
 */
public class VerElectronicaE extends javax.swing.JFrame {

    DefaultTableModel modelo = new DefaultTableModel();

    public VerElectronicaE() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerElectronicaE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerElectronicaE().setVisible(true);
            }
        });
    }
